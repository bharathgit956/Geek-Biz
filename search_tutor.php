...
<html>
  ...
  <body>
    ...
    <form>
      <br/>
      <fieldset>
        <legend>Search Tutor by Zip</legend>
        <div class="topnav">
			<input id="zip" type="search"   name="zip" required pattern="[0-9]{5}" title = "Must Contain 5 Numbers" placeholder = "Search . . . "/>
		</div>
		<div class="btn-block">
      		<button type="Order" href="/"> Search <i class="fa fa-search"></i> </button>
      </div>
      </fieldset>
      <br/>
